...
typedef union {
	...
	uint64_t word;
} MMC_COMMON_DEVICE_SECURITY_LEVEL_t;
...
typedef union {
	struct {
		 ...
		 */
		uint64_t card_int_ovd       : 1;
		/* Reserved. */
		uint64_t __reserved_4       : 1;
		/* Value to apply to Card-Interrupt when CARD_INT_OVD is 1. */
		uint64_t card_int_ovd_val   : 1;
		/* Reserved. */
		uint64_t __reserved_5       : 19;
		/*
